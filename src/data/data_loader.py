...
if __name__ == "__main__":
    # Pretty display options for quick inspection
    ...
    fb.load_offline()
    fb.combine()
    fb.save_processed(out_file="data/processed/fbref/fbref.csv")
    print("Saved combined FBref data -> data/processed/fbref/fbref.csv")
    print(fb.all_players.head())

    # --- Transfermarkt ---
    tm = TransfermarktDataBase()
    tm.load_offline()
    tm.clean()
    tm.save_processed(out_dir="data/processed/transfermarkt")
    print("Saved Transfermarkt artifacts -> data/processed/transfermarkt/")
    print("Merged (club_games ⟷ games) sample:")
    print(tm.games_clubgames.head())
